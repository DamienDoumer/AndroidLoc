...
import com.example.dtohi.saferoad.Listeners.SelectionOptionListener;
...
public class MainActivity extends AppCompatActivity implements OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new SelectionOptionListener(drawer, getSupportFragmentManager()));
    }
